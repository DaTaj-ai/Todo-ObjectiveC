...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [self.taskManager applyFilter:TaskProgress];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (task.priority) {
        case TaskPriorityHigh:
            cell.priorityImageView.image = [UIImage imageNamed:@"high_priority"];
            break;
        case TaskPriorityMedium:
            cell.priorityImageView.image = [UIImage imageNamed:@"medium_priority"];
            break;
        case TaskPriorityLow:
            cell.priorityImageView.image = [UIImage imageNamed:@"low_priority"];
            break;
    }
